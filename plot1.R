...
## I have saved the dataset in ./data directory in my PC. We need to read that dataset and have to subset
...
## then creates a plot1.png file and then creates the histogram
